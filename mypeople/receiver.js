...
var bot = new Bot({
	...
	apiKey: "8a29cc1dbc317d6f2ed6ddabee997f1db1333700"
});
...
exports.addBuddy = function(buddyId) {
	...
	bot.buddyProfile(buddyId, function(error, data) {
		if(!error){
			var reply = '주아가 보고 싶으면 언제든 주아라고 말해';
...
exports.sendFromGroup = function(groupId, content) {

		if(content.indexOf("주아")>-1){
